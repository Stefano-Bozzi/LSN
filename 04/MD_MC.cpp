...
{ 
  ...
  int nconf = 1;
  //Averages(0);
  for(int istep=1; istep <= 1000; istep++) 	//serve per far partire la simulzione senza considerare il tempo di equilibrazione prima, 3000 per sol e liq e 120000 per gas
    {
      Move();
    }
    //*/
...
void Averages(int iblk) //Print results for current block
{
   ...
   ofstream Epot, Ekin, Etot, Temp, Pres;	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////, Pres;
   const int wd=12;
...
//Total energy
    Etot << setw(wd) << std::scientific << iblk <<  setw(wd) << stima_etot << setw(wd) << glob_av[ie]/(double)iblk << setw(wd) << err_etot << endl;	////////////////////////////////////////
//Temperature
